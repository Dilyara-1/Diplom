  ...
  return (
    <div>
      <h1 className="text-2xl py-4">
        Редактирование товара {formatId(productId)}
      </h1>
      <div>
        <form onSubmit={handleSubmit(formSubmit)}>
          <FormInput name="Название" id="name" required />
          <FormInput name="Код" id="slug" required />
          <FormInput name="Изображение" id="image" required />
          <div className="md:flex mb-6">
          ...
          <FormInput name="Коллекция" id="brand" required />
          <FormInput name="Описание" id="description" required />
          <FormInput name="Наличие" id="countInStock" required />
